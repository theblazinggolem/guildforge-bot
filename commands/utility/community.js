    ...
    data: new SlashCommandBuilder()
        ...
        .addBooleanOption((option) =>
            option
                .setName("enabled")
                .setDescription(
                    "Whether to enable or disable community features."
                )
                .setRequired(true)
        )
        .addChannelOption((option) =>
            option
                ...
                .setDescription(
                    "The channel to use for server rules (optional: will be created if not specified)."
                )
        ...
        .addChannelOption((option) =>
            option
                ...
                .setDescription(
                    "The channel to use for community updates (optional: will be created if not specified)."
                )
                .addChannelTypes(ChannelType.GuildText)
                .setRequired(false)
        ),
    ...
    async execute(interaction) {
        ...
        try {
            ...
            if (enableCommunity) {
                ...
                let updatesChannel =
                    interaction.options.getChannel("updates_channel");
                let createdChannels = [];
                ...
                if (!rulesChannel) {
                    try {
                        ...
                        return interaction.editReply({
                            content:
                                "Failed to create rules channel. Please provide an existing channel or check bot permissions.",
                        });
                    }
                }
                ...
                if (!updatesChannel) {
                    try {
                        ...
                        return interaction.editReply({
                            content:
                                "Failed to create community updates channel. Please provide an existing channel or check bot permissions.",
                        });
                    }
                }
                ...
                try {
                    ...
                    return interaction.editReply({
                        content: `Failed to enable community: ${
                ...
                try {
                    ...
                    return interaction.editReply({
                        content: `Failed to disable community features: ${
                            err.message || "Unknown error"
                        }`,
                    });
                }
